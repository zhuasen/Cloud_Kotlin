...
import com.kotlin.cloudkotlin.activity.ChangePassword
import com.kotlin.cloudkotlin.activity.Login
import com.kotlin.cloudkotlin.activity.MainActivity
import com.kotlin.cloudkotlin.activity.Register
import com.kotlin.cloudkotlin.kotlinUtil.*
import java.io.File
...
//传入任务类型
class UserAsyncTask (private val taskType: Int) : AsyncTask<Unit, Float?, Int>() {
    ...
    override fun doInBackground(vararg params: Unit): Int {
        when (taskType) {
            ...
            //主页面退出时清理垃圾
            CLEAR_MAIN_CACHE->{
                deleteDir(OssApplication.Context.cacheDir)
                if (Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) deleteDir(OssApplication.Context.externalCacheDir)
    ...
    companion object{
        ...
        //注册事件：
        const val REGISTER_TASK = 37
        private const val REGISTER_SUCCESS = 38
        private const val REGISTER_DUPLICATION_ACCOUNT = 39
        private const val REGISTER_SERVICE_FAIL = 40
        private const val REGISTER_NETWORK_FAIL = 41

        //登陆事件
        const val LOGIN_TASK = 42
        private const val LOGIN_SUCCESS = 43
        private const val LOGIN_ERROR_ACCOUNT = 44
        private const val LOGIN_ERROR_PASSWORD = 45
        private const val LOGIN_IOE_ERROR = 46
        private const val LOGIN_SERVICE_FAIL = 47
        private const val LOGIN_NETWORK_FAIL = 48

        //修改密码
        const val CHANGE_PASSWORD_TASK = 55
        private const val CHANGE_PASSWORD_SUCCESS = 56
        private const val CHANGE_WRONG_PASSWORD_FAIL = 57
        private const val CHANGE_PASSWORD_NETWORK_FAIL = 58
        private const val CHANGE_PASSWORD_SERVICE_FAIL = 59
        private const val CHANGE_PASSWORD_IOE_FAIL = 60

        //注销账户指令
        const val DELETE_ACCOUNT_TASK = 23
        private const val DELETE_NETWORK_FAIL = 24
        private const val DELETE_SERVICE_FAIL = 25
        private const val DELETE_ACCOUNT_SUCCESS = 26

        //清理垃圾
        const val CLEAR_LOGIN_CACHE = 49
        const val CLEAR_REGISTER_CACHE = 50
        const val CLEAR_MAIN_CACHE = 51
        private const val CLEAR_CACHE_LOGIN_SUCCESS = 52
        private const val CLEAR_CACHE_REGISTER_SUCCESS = 53
        private const val CLEAR_CACHE_MAIN_SUCCESS = 54
